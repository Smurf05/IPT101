...
AS
	...
	END
GO
PRINT N'Altering Procedure [dbo].[DeleteMoto]...';


GO
ALTER PROCEDURE [dbo].[DeleteMoto]
...
AS
	...
	END
GO
PRINT N'Altering Procedure [dbo].[GetAllMoto]...';


GO
ALTER PROCEDURE [dbo].[GetAllMoto]

AS
	Select * From Motorcycle
GO
PRINT N'Altering Procedure [dbo].[GetMoto]...';


GO
ALTER PROCEDURE [dbo].[GetMoto]
	@Brand nvarchar (50) = NULL
AS
BEGIN
...
END
GO
PRINT N'Altering Procedure [dbo].[UpdateMoto]...';


GO
ALTER PROCEDURE [dbo].[UpdateMoto]
	@Brand NVARCHAR(50) NOT NULL, 
    @Color NCHAR(50) NULL, 
    @Model NCHAR(50) NULL, 
    @Engine_Number NCHAR(50) NULL, 
